...
from mmcls.cvcore.utils import mkdir_or_exist
...
def get_external_models():
    ...
    default_json_path = osp.join('models/', 'model_zoo/open_mmlab.json')
...
def get_mmcls_models():
    mmcls_json_path = osp.join('models/', 'model_zoo/mmcls.json')
...
def get_deprecated_model_names():
    deprecate_json_path = osp.join('models/',
...
def save_checkpoint(model, filename, optimizer=None, meta=None):
    ...
    meta.update(mmcv_version='0.0.1', time=time.asctime())
